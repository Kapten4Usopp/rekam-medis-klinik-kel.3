...
$url = 'http://localhost/rekam-medis-klinik/';
            ...
            <div class="card bg-authentication rounded-0 mb-0">
              <div class="row m-0">
                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                  <img src="../../assets/images/pages/login2.jpg" alt="branding logo" height="295" width="321">
                </div>
                <div class="col-lg-6 col-12 p-0">
                  <div class="card rounded-0 mb-0 px-2">
                    <div class="card-header pb-1">
                      <div class="card-title">
                        <h4 class="mb-0">L O G I N !!!</h4>
                      </div>
                    </div>
                    <p class="px-2">Selamat Datang Kembali, Silahkan Login Di Halaman Ini </p>
