  ...
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="index.php">
          ...
          <h2 class="brand-text mb-0">Klinik SYK</h2>
        </a></li>
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      <li class="<?php echo is_active(''); ?> nav-item">
        <a href="index.php"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Halaman Utama</span></a>
      </li>
      ...
      <li class="<?php echo is_active('obat'); ?> nav-item"><a href="?page=obat"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Obat">Daftar Obat</span></a>
      </li>
      ...
      <li class="nav-item"><a href="javascript:;"><i class="feather icon-pie-chart"></i><span class="menu-title" data-i18n="Laporan">Laporan</span></a>
        <ul class="menu-content">
          <li class="<?php echo is_active('lap-rekam-medis'); ?>"><a href="?page=lap-rekam-medis"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Rekam Medis"> Hasil Rekam Medis</span></a>
          </li>
        </ul>
      </li>
